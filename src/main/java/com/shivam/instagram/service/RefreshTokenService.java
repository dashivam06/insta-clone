...
public class RefreshTokenService {
    ...
    public RefreshToken saveRefreshToken(String userKey) {
        ...
        RefreshToken refreshToken = new RefreshToken(token, refreshTokenJwtUtil.extractUserId(token),
                Time.getGMT_Time("yyyy-MM-dd HH:mm:ss"), Time.getGMT_Time("yyyy-MM-dd HH:mm:ss"));
